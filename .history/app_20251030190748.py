    ...
    def get_candidate_assessment_for_job(self, candidate_id, job_id):
        ...
        try:
            ...
            try:
                ...
                university_scores = self.enhanced_assessment_engine.calculate_detailed_scores(pds_data)
                university_total = self.enhanced_assessment_engine.calculate_total_score(pds_data)
