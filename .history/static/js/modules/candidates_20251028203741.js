    ...
    async showCandidateDetails(candidateId) {
        ...
        try {
            ...
            if (data.success) {
                ...
                console.error('Failed to load candidate:', candidateId, data.error);
                // Check if candidate doesn't exist (404 error)
                if (data.error && data.error.includes('404') || data.error.includes('not found')) {
                    ...
                    // Refresh the candidate list to update the display
                    setTimeout(() => {
                        this.loadCandidates();
                    }, 2000);
                } else {
