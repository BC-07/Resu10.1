...
const CandidatesModule = {
    ...
    renderHybridScoringResults(hybridData) {
        ...
        const hybridScores = hybridData.hybrid_scores || {};
                            ...
                            <div class="scoring-method-card university-method">
                                <div class="method-header">
                                    ...
                                    <div class="method-score">
                                        <span class="score-value">${universityScores.overall_total || 0}</span>
                        ...
                        <div class="col-md-6">
                            <div class="scoring-method-card semantic-method">
                                <div class="method-header">
                                    ...
                                    <div class="method-score">
                                        <span class="score-value">${semanticScores.overall_relevance_score || 0}</span>
                    ...
                    <div class="hybrid-score-card">
                        ...
                        <div class="hybrid-scores">
                            <div class="hybrid-score-item">
                                ...
                                <span class="value">${universityScores.overall_total || 0}/100</span>
                                <div class="score-bar">
                                    <div class="score-fill university" style="width: ${universityScores.overall_total || 0}%"></div>
                                </div>
                            </div>
                            <div class="hybrid-score-item">
                                <span class="label">Semantic Relevance:</span>
                                <span class="value">${semanticScores.overall_relevance_score || 0}%</span>
                                <div class="score-bar">
                                    <div class="score-fill semantic" style="width: ${semanticScores.overall_relevance_score || 0}%"></div>
                                </div>
                            </div>
                            <div class="hybrid-score-item total">
                                <span class="label">Combined Assessment:</span>
                                <span class="value">${hybridScores.combined_score || 0}</span>
                                <div class="score-bar">
                                    <div class="score-fill hybrid" style="width: ${(hybridScores.combined_score || 0)}%"></div>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        return `
            <div class="university-breakdown">
                <div class="breakdown-item">
                    ...
                    <span class="item-score">${universityScores.education_score || 0}/40</span>
                </div>
                <div class="breakdown-item">
                    <span class="item-label">Experience (20%):</span>
                    <span class="item-score">${universityScores.experience_score || 0}/20</span>
                </div>
                <div class="breakdown-item">
                    <span class="item-label">Training (10%):</span>
                    <span class="item-score">${universityScores.training_score || 0}/10</span>
                </div>
                <div class="breakdown-item">
                    <span class="item-label">Eligibility (10%):</span>
                    <span class="item-score">${universityScores.eligibility_score || 0}/10</span>
                </div>
                <div class="breakdown-item">
                    <span class="item-label">Accomplishments (5%):</span>
                    <span class="item-score">${universityScores.accomplishments_score || 0}/5</span>
                </div>
                <div class="breakdown-item">
                    <span class="item-label">Potential (15%):</span>
                    <span class="item-score">${universityScores.potential_score || 0}/15</span>
                </div>
            </div>
        `;
    },
    ...
    renderSemanticBreakdown(semanticScores) {
        return `
            <div class="semantic-breakdown">
                ...
                <div class="breakdown-item">
                    <span class="item-label">Skills Alignment:</span>
                    <span class="item-score">${(semanticScores.skills_relevance || 0).toFixed(1)}%</span>
                </div>
                <div class="breakdown-item">
                ...
                <div class="breakdown-item total">
                    ...
                    <span class="item-score">${(semanticScores.overall_relevance_score || 0).toFixed(1)}%</span>
                </div>
            </div>
        `;
    },
    ...
    async populateSemanticAnalysis(candidate) {
        ...
        try {
            const jobId = this.getJobIdForCandidate(candidate);
            if (jobId) {
                const response = await fetch(`/api/candidates/${candidate.id}/semantic-analysis/${jobId}`);
                if (response.ok) {
                    const result = await response.json();
                    if (result.success) {
                        this.renderSemanticAnalysisResults(result.data);
                    } else {
                        this.renderSemanticAnalysisError('Failed to load semantic analysis');
                    }
                } else {
    ...
    renderSemanticAnalysisResults(semanticData) {
        ...
        const analysis = semanticData.semantic_analysis || {};
        const insights = semanticData.insights || [];
        const recommendations = semanticData.recommendations || [];
                ...
                <div class="semantic-overview">
                    <div class="relevance-score-display">
                        <div class="relevance-circle">
                            <div class="circle-chart" data-percentage="${analysis.overall_relevance_score || 0}">
                                <span class="percentage">${(analysis.overall_relevance_score || 0).toFixed(1)}%</span>
                    ...
                    <div class="relevance-categories">
                        <div class="relevance-category">
                            <div class="category-header">
                                ...
                                <span class="category-score">${(analysis.education_relevance || 0).toFixed(1)}%</span>
                            </div>
                            <div class="category-bar">
                                <div class="bar-fill education" style="width: ${analysis.education_relevance || 0}%"></div>
                            </div>
                        ...
                        <div class="relevance-category">
                            <div class="category-header">
                                ...
                                <span class="category-score">${(analysis.experience_relevance || 0).toFixed(1)}%</span>
                            </div>
                            <div class="category-bar">
                                <div class="bar-fill experience" style="width: ${analysis.experience_relevance || 0}%"></div>
                            </div>
                            <div class="category-insights">
                        ...
                        <div class="relevance-category">
                            <div class="category-header">
                                <span class="category-name">Skills & Training</span>
                                <span class="category-score">${(analysis.skills_relevance || 0).toFixed(1)}%</span>
                            </div>
                            <div class="category-bar">
                                <div class="bar-fill skills" style="width: ${analysis.skills_relevance || 0}%"></div>
                            </div>
                            <div class="category-insights">
                                ${analysis.skills_insights ? `<p class="insight">${analysis.skills_insights}</p>` : ''}
                            </div>
                        </div>
                    </div>
                </div>
        ...
        try {
            ...
            if (response.ok) {
                ...
                if (result.success) {
                    ...
                    this.renderAssessmentComparisonError('Failed to load comparison data');
                }
            } else {
    ...
    renderTraditionalBreakdown(traditional) {
        return `
            <div class="traditional-breakdown">
                <div class="breakdown-item">
                    <span>Education:</span>
                    <span>${traditional.education_score || 0}/40</span>
                </div>
                <div class="breakdown-item">
                    <span>Experience:</span>
                    <span>${traditional.experience_score || 0}/20</span>
                </div>
                <div class="breakdown-item">
                    <span>Training:</span>
                    <span>${traditional.training_score || 0}/10</span>
                </div>
                <div class="breakdown-item">
                    <span>Eligibility:</span>
                    <span>${traditional.eligibility_score || 0}/10</span>
                </div>
            </div>
        `;
    },
        ...
        return `
            <div class="enhanced-breakdown">
                ...
                <div class="breakdown-item">
                    ...
                    <span>${enhanced.semantic_bonus || 0}/15</span>
                </div>
                <div class="breakdown-item">
    ...
    getJobIdForCandidate(candidate) {
        // Try to get job ID from candidate data
        return candidate.job_id || candidate.position_id || null;
    },
