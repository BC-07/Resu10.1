        ...
        try:
            ...
            try:
                ...
                assessment_result = {
                    ...
                    'enhanced_assessment': {
                        'semantic_score': round(semantic_score * 100 if semantic_score else 0, 2),
                        'traditional_score': round(traditional_score if traditional_score else 0, 2),
                        'recommended_score': round(recommended_score * 100 if recommended_score else 0, 2),
                    ...
                    'hybrid_score': round(recommended_score * 100 if recommended_score else 0, 2)
                }
                
                logger.info(f"✅ Hybrid assessment completed - Traditional: {traditional_score:.2f}, Semantic: {semantic_score:.2f}, Recommended: {recommended_score:.2f}")
