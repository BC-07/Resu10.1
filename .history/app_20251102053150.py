...
class PDSAssessmentApp:
    ...
    def get_assessment_trends(self):
        ...
        try:
            ...
            # Return fallback data - avoid complex SQL for now
            fallback_data = {
                'success': True,
                'trends': {
                    'daily_assessments': [
            ...
            try:
                ...
                if basic_analytics:
                    ...
                    fallback_data['trends']['daily_assessments'][0]['total_assessments'] = total_candidates
                    fallback_data['trends']['daily_assessments'][0]['avg_score'] = avg_score
