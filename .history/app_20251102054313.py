...
class PDSAssessmentApp:
    ...
    def get_assessment_trends(self):
        ...
        try:
            ...
            # Return fallback data in the format frontend expects
            daily_data = [
            ...
            try:
                ...
                if basic_analytics:
                    ...
                    # Update first data point with real data
                    ...
                    fallback_data['scores'][0] = avg_score
    ...
    def get_assessment_insights(self):
        ...
        try:
            ...
            # Return structured insights data
            fallback_insights = {
                'success': True,
                'insights': {
                    'performance_summary': {
