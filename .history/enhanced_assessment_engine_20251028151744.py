...
class EnhancedUniversityAssessmentEngine(UniversityAssessmentEngine):
    ...
    def __init__(self, db_manager=None):
        ...
        # Semantic scoring weights (configurable)
    ...
    def _calculate_semantic_assessment(self, candidate_data: Dict, job_data: Dict) -> Dict:
        ...
        skills_relevance = semantic_details.get('skills_relevance', 0.0)
        ...
        weighted_score = (
            ...
            skills_relevance * self.semantic_weights['skills_relevance']
        )
        ...
        breakdown = {
            ...
            'skills_relevance': round(skills_relevance, 3),
            ...
            'weighted_components': {
                ...
                'skills_weighted': round(skills_relevance * self.semantic_weights['skills_relevance'], 3),
