...
def test_complete_integration():
    ...
    try:
        ...
        cursor.execute("""
            SELECT id, name, extracted_text, education, experience, skills 
            FROM candidates 
            LIMIT 3
        """)
            ...
            for candidate in candidates:
                if hasattr(candidate, 'keys'):  # RealDictRow
                    ...
                    candidate_dict = {
                        ...
                        'education': candidate[3] or '',
                        'experience': candidate[4] or '',
                        'skills': candidate[5] or ''
                    }
        ...
        for i, candidate in enumerate(candidates):
            ...
            try:
                ...
                print(f"   🔧 Traditional Score: {result.get('traditional_score', 0):.1f}")
                ...
                results.append({
                    ...
                    'traditional_score': result.get('traditional_score', 0),
        ...
        batch_results = enhanced_engine.assess_candidates_batch(
        ...
        if results:
            ...
            avg_traditional = sum(r['traditional_score'] for r in results) / len(results)
