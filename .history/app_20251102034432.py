...
class PDSAssessmentApp:
    def __init__(self):
        ...
        # Initialize semantic engine with error handling
        try:
        ...
        try:
            ...
            if job_id:
                try:
                    ...
                    job_posting = db_manager.get_lspu_job_posting(job_id)
                    if job_posting:
                        # Perform hybrid assessment including semantic analysis
                        hybrid_result = self._perform_hybrid_assessment(candidate, job_posting)
                        if hybrid_result and hybrid_result.get('enhanced_assessment'):
                            enhanced_total = hybrid_result['enhanced_assessment'].get('total_score', 0)
                            return round(enhanced_total, 1)
                except Exception as e:
    ...
    def get_candidates(self):
        ...
        try:
            ...
            for candidate in candidates:
                ...
                # Calculate enhanced assessment score including semantic analysis
                enhanced_score = self._calculate_enhanced_assessment_score(candidate, job_id if job_id != 'unassigned' else None)
                formatted_candidate['assessment_score'] = enhanced_score
                formatted_candidate['score'] = enhanced_score  # Update the score field too
            ...
            try:
                ...
                try:
                    if self.semantic_engine is not None:
                        ...
                        logger.info("✅ Detailed semantic analysis completed successfully")
                    else:
                ...
                assessment_result = {
                    ...
                    'semantic_analysis': {
                        ...
                        'training_insights': semantic_result.get('training_insights', 'Training analysis not available')
                    },
        ...
        try:
            ...
            comparison_data = {
                ...
                'enhanced_assessment': {
                    ...
                    'factors': ['PDS Educational Assessment', 'Experience Relevance Analysis', 'Training Program Evaluation', 'Semantic Job Matching']
                },
                'differences': {
                    ...
                    'method_advantages': [
                        ...
                        'Structured PDS data analysis',
                        'AI-enhanced educational background evaluation',
                        'Comprehensive civil service eligibility verification'
                    ]
                },
                'improvement_metrics': {
                    'score_difference': round(semantic_enhancement, 2),
